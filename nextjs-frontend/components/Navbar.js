        ...
        <nav className="p-4 bg-background/50 sticky top-0 backdrop-blur border-b z-10">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-4 items-center">
                    ...
                    {user ? (
            <>
              <span className="text-indigo-600 font-medium">Welcome, {user.username}</span>
              <button
                onClick={logout}
                className="hover:text-gray-900 px-4 py-2"
              >
                Logout
              </button>
            </>
            ...
            <>
              <Link href="/login" className="hover:text-gray-900 px-4 py-2">Login</Link>
              <Link href="/signup" className="hover:text-gray-900 px-4 py-2">SignUp</Link>
            </>
          )}
